#ifndef SIMULATOR_QUALITY_BY_CONTEXT_SET_H_
#define SIMULATOR_QUALITY_BY_CONTEXT_SET_H_

#include "simulator/ContextSample.h"
#include <map>
#include <iostream>
using namespace std;
typedef map<string,ContextSample*> T_ContextSampleMap;

class QualtyByContextSet : public T_ContextSampleMap {
 public:
 int contextLength;
